#
#   Makefile - Embedthis Kickstart Makefile wrapper for per-platform makefiles
#
...
all compile:
	...
	@echo ; echo 'You can now deploy via "make $(MAKEFLAGS) deploy" or run via: "sudo make run"'
...
help:
	@echo '' >&2
	@echo 'usage: make [clean, compile, deploy, run]' >&2
	@echo '' >&2
	...
	@echo '' >&2
	@echo '  ME_KICKSTART_CGI=0 make' >&2
	@echo '' >&2
