...
angular.module('app').controller('PortControl', ["Esp", "Port", "Vlan", "$rootScope", "$scope", "$location", "$routeParams", function (Esp, Port, Vlan, $rootScope, $scope, $location, $routeParams) {
