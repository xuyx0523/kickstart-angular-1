...
}).factory('Esp', ["SessionStore", "$document", "$http", "$injector", "$location", "$rootScope", "$timeout", "$window", function(SessionStore, $document, $http, $injector, $location, $rootScope, $timeout, $window) {
...
.config(["$httpProvider", "$routeProvider", function($httpProvider, $routeProvider) {
     ...
     */
    $httpProvider.interceptors.push(["$cacheFactory", "$injector", "$location", "$q", "$rootScope", "$window", function($cacheFactory, $injector, $location, $q, $rootScope, $window) {
        return {
