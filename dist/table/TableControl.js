 ...
 */
angular.module('app').controller('TableControl', ["$rootScope", "$scope", "$location", "$routeParams", "Table", "Esp", function ($rootScope, $scope, $location, $routeParams, Table, Esp) {
...
angular.module('app').config(["$routeProvider", function($routeProvider) {
    ...
    $routeProvider.when('/table/list', angular.extend({}, Default, {templateUrl: esp.url('/table/list.html')}));
    $routeProvider.when('/table/:id',  angular.extend({}, Default, {templateUrl: esp.url('/table/edit.html')}));
}]);
