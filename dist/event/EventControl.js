...
angular.module('app').controller('EventControl', ["Esp", "Event", "$filter", "$rootScope", "$scope", "$location", "$routeParams", function (Esp, Event, $filter, $rootScope, $scope, $location, $routeParams) {
