...
angular.module('app').controller('UserControl', ["Esp", "User", "$rootScope", "$route", "$scope", "$location", "$modal", "$routeParams", "$timeout", "$window", function (Esp, User, $rootScope, $route, $scope, $location, $modal, $routeParams, $timeout, $window) {
    ...
    $scope.forgot = function() {
        ...
        var confirm = $modal.open({
            scope: $scope,
            templateUrl: esp.url('/user/forgot.html'),
        });
...
angular.module('app').config(["$routeProvider", function($routeProvider) {
    ...
    $routeProvider.when('/user/list',   angular.extend({}, Default, {templateUrl: esp.url('/user/list.html')}));
    $routeProvider.when('/user/login',  angular.extend({}, Default, {templateUrl: esp.url('/user/login.html')}));
    ...
    $routeProvider.when('/user/:id', angular.extend({}, Default, {
        templateUrl: esp.url('/user/edit.html'),
