...
angular.module('app').controller('VlanControl', ["Esp", "Vlan", "$modal", "$rootScope", "$scope", "$location", "$routeParams", function (Esp, Vlan, $modal, $rootScope, $scope, $location, $routeParams) {
