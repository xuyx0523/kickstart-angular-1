#
#   kick-vxworks-default.mk -- Makefile to build Embedthis Kickstart for vxworks
#
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/kick-vxworks-default-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/kick-vxworks-default-bit.h >/dev/null ; then\
		cp projects/kick-vxworks-default-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
