#
#   kick-macosx-default.mk -- Makefile to build Embedthis Kickstart for macosx
#
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/kick-macosx-default-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/kick-macosx-default-bit.h >/dev/null ; then\
		cp projects/kick-macosx-default-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
