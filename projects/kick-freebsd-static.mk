#
#   kick-freebsd-static.mk -- Makefile to build Embedthis Kickstart for freebsd
#
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/kick-freebsd-static-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/kick-freebsd-static-bit.h >/dev/null ; then\
		cp projects/kick-freebsd-static-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
