#
#   kick-linux-default.mk -- Makefile to build Embedthis Kickstart for linux
#
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/kick-linux-default-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/kick-linux-default-bit.h >/dev/null ; then\
		cp projects/kick-linux-default-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
